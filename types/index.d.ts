declare namespace xutils {
  ...
  export interface SimpleQ extends Promise<any> {
    ...
    progress(
      cb: (
        value: "resolved" | "rejected" | "in_progress" | "timeout",
        time?: number
      ) => void,
      every?: number,
      timeout?: number
  ...
  export function selectiveArray(
