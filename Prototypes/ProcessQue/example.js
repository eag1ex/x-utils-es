...
import { processQue, BaseProcessModel } from '.'

/** Provide an array of items, where each item will become a BaseProcessModel */
let inputList = [
    { id: '123abc', data: { v: 1 }, list: [1, 2, 3] }, // new BaseProcessModel({...}) // (item)
    { id: '123efg', data: { v: 3 }, list: [1, 2, 3] } // new BaseProcessModel({...}) // (item)
]

/*
Optional extention of BaseProcessModel
...
class ProcessX extends BaseProcessModel {
...
processQue({ inputList, /** Optional */ ProcessMod: ProcessX }, true)
    .processQue(
